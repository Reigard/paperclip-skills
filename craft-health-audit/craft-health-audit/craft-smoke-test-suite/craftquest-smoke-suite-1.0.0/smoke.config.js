...
// 1. Dynamic Base URL and Site Name
const baseUrl = process.env.SMOKE_BASE_URL || process.env.CRAFT_SITE_URL || 'https://utahadopt.org';
...
if (!templates || templates.length === 0) {
  // Default auto-generated template assertion for key pages
  templates = [
